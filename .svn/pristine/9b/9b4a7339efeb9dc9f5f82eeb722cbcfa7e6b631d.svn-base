...
namespace DONGSHIN
{
    public partial class ctl_commonCode : UserControl
    {
        public ctl_commonCode()
        {
            InitializeComponent();
        ...
        private DataSet ds_commonCode = new DataSet();
        private DataRow parentRow;
        private string commonID = "";

        private void ctl_commonCode_Load(object sender, EventArgs e)
        {
            userProvisioning("170000");
            edit= new ctl_commonEdit(this);
            setVisible(pan_sub, true);
            read();
        }

        private void ctl_commonCode_VisibleChanged(object sender, EventArgs e)
        {
            if ( this.Visible == true )
                ctl_commonCode_Load(this, e);
        }
        ...
        private void btn_update_Click(object sender, EventArgs e)
        {
            if ( btn_update.Enabled == true )
            {
                ...
                try
                {
                    ...
                    {
                        commonID = parentRow["gt_id"].ToString();
                        edit.setID(commonID);
        ...
        private void btn_delete_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                if ( question == DialogResult.Yes )
                {
                    ...
                    Return = fx_commonCode.delete(commonVar.DBconn, commonID);
        ...
        private void btn_dataconvert_Click(object sender, EventArgs e)
        {
            if ( btn_dataconvert.Enabled == true )
            {
                ...
                tmF.Grid받기(lbl_title.Text, "공통코드", gridView1);
        ...
        private void read() 
        {
            ...
            Return = fx_commonCode.read_all(commonVar.DBconn);

            if ( Return.Message == "" )
            {
                ds_commonCode = Return.Dataset;
        ...
        private void conditionalRead() 
        {
            ...
            Return = fx_commonCode.findByName(commonVar.DBconn, txt_grpName.Text);
        ...
        {
            if ( ds_commonCode.Tables.Count > 0 )
            {
                if ( ds_commonCode.Tables[0].Rows.Count > 0 )
                {
                    FormGridFilter FormFilter = new FormGridFilter();

                    FormFilter.Grid넘기기(ref ds_commonCode, ref gridView1);
        ...
        private void txt_grpName_KeyDown(object sender, KeyEventArgs e)
        {
