namespace DONGSHIN
{
    partial class MachineListControl
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.controlCoolingWaterOut = new DONGSHIN.MachineValueItemControl();
            this.controlCoolingWaterIn = new DONGSHIN.MachineValueItemControl();
            this.controlMoldTemp2 = new DONGSHIN.MachineValueItemControl();
            this.controlMoldTemp1 = new DONGSHIN.MachineValueItemControl();
            this.controlH4 = new DONGSHIN.MachineValueItemControl();
            this.controlH3 = new DONGSHIN.MachineValueItemControl();
            this.controlH2 = new DONGSHIN.MachineValueItemControl();
            this.controlH1 = new DONGSHIN.MachineValueItemControl();
            this.controlNozzle = new DONGSHIN.MachineValueItemControl();
            this.controlCurrentCount = new DONGSHIN.MachineValueItemControl();
            this.controlTargetCount = new DONGSHIN.MachineValueItemControl();
            this.stateMonitor = new DONGSHIN.MachineStateItemControl();
            this.stateHeater = new DONGSHIN.MachineStateItemControl();
            this.stateMotor = new DONGSHIN.MachineStateItemControl();
            this.stateAlarm = new DONGSHIN.MachineStateItemControl();
            this.stateDriveMode = new DONGSHIN.MachineStateItemControl();
            this.controlMakingTime = new DONGSHIN.MachineValueItemControl();
            this.controlOil = new DONGSHIN.MachineValueItemControl();
            ...
            this.controlH1.BorderTop = false;
            ...
            this.controlNozzle.BorderTop = false;
