...
namespace DONGSHIN
{
    ...
    public class FTPclient
    {
        ...
        //FTP Connect Event
        public delegate void FtpConnectHandler(object sender, FtpConnectEventArgs e);
        public event FtpConnectHandler OnFtpConnected;
    ...
    #region Events
    public class FtpConnectEventArgs : EventArgs
    {
        //Private Members
        ...
        //Constructor
        public FtpConnectEventArgs(string Type, string Status, string Code)
        {
