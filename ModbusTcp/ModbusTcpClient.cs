...
namespace ModbusTcp
{
    public class ModbusTcpClient
    {
        ...
        public class ModbusProtocol
        {
            ...
            public readonly byte[] ProtocolId = new byte[] { 0x00, 0x00 };
        ...
        private byte[] MakeReadFrame(ModbusProtocol _modbus)
        {
            ...
            dataFrame[(int)Enums.ModbusIndex.ProtocolId_1st] = _modbus.ProtocolId[0];
            dataFrame[(int)Enums.ModbusIndex.ProtocolId_2nd] = _modbus.ProtocolId[1];
